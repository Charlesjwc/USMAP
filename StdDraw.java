    ...
    ***************************************************************************/
	 ...
	 */
	 ...
	 public static void drawCity() {
		ArrayList<String> bigCityName = new ArrayList<String>();
		ArrayList<String> bigCityPop = new ArrayList<String>();
		try {
			File newFile = new File("bigCities.txt");
			...
			while (newReader.hasNextLine()) {
				...
				//StdDraw.text(100, 22+i, population);
				i++;
			}
			newReader.close();
			} catch (FileNotFoundException e) {
				StdDraw.setPenColor(StdDraw.GRAY);
				StdDraw.text(80, 30, "FileNotFound");
				e.printStackTrace();
			}
		try {
			...
			while (newReader.hasNextLine()) {
				String data = newReader.nextLine();
				String coord1 = data.substring(0, data.indexOf(" "));
				String coord2b = data.substring(data.indexOf(" ")+1, data.indexOf(",")-1);
				String coord2 = coord2b.substring(0, data.indexOf(" "));
